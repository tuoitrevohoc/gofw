...
func (cc *CredentialCreate) SetPublicKey(s string) *CredentialCreate {
	cc.mutation.SetPublicKey(s)
	return cc
}

// SetData sets the "data" field.
func (cc *CredentialCreate) SetData(s string) *CredentialCreate {
...
func (cc *CredentialCreate) check() error {
	...
	if v, ok := cc.mutation.PublicKey(); ok {
	...
	if _, ok := cc.mutation.Data(); !ok {
		return &ValidationError{Name: "data", err: errors.New(`ent: missing required field "Credential.data"`)}
	}
