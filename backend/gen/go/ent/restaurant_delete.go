...
// Where appends a list predicates to the RestaurantDelete builder.
...
func (rd *RestaurantDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(restaurant.Table, sqlgraph.NewFieldSpec(restaurant.FieldID, field.TypeInt))
...
// Where appends a list predicates to the RestaurantDelete builder.
func (rdo *RestaurantDeleteOne) Where(ps ...predicate.Restaurant) *RestaurantDeleteOne {
