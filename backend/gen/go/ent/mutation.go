...
func (m *RefreshTokenMutation) SetRefreshAt(t time.Time) {
	m.refresh_at = &t
}

// RefreshAt returns the value of the "refresh_at" field in the mutation.
func (m *RefreshTokenMutation) RefreshAt() (r time.Time, exists bool) {
	v := m.refresh_at
	if v == nil {
		return
	}
...
// OldRefreshAt returns the old "refresh_at" field's value of the RefreshToken entity.
// If the RefreshToken object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RefreshTokenMutation) OldRefreshAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RefreshTokenMutation) ResetRefreshAt() {
	m.refresh_at = nil
}

// SetExpireAt sets the "expire_at" field.
func (m *RefreshTokenMutation) SetExpireAt(t time.Time) {
	m.expire_at = &t
}

// ExpireAt returns the value of the "expire_at" field in the mutation.
func (m *RefreshTokenMutation) ExpireAt() (r time.Time, exists bool) {
	v := m.expire_at
	if v == nil {
		return
	}
...
// OldExpireAt returns the old "expire_at" field's value of the RefreshToken entity.
// If the RefreshToken object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RefreshTokenMutation) OldExpireAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RefreshTokenMutation) ResetExpireAt() {
	m.expire_at = nil
}
...
func (m *RefreshTokenMutation) Fields() []string {
	...
	if m.refresh_at != nil {
		fields = append(fields, refreshtoken.FieldRefreshAt)
	}
	if m.expire_at != nil {
		fields = append(fields, refreshtoken.FieldExpireAt)
	}
	if m.ip_address != nil {
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *RestaurantMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
type UserMutation struct {
	...
	restaurants           map[int]struct{}
	removedrestaurants    map[int]struct{}
...
// ClearAccessTokens clears the "access_tokens" edge to the RefreshToken entity.
func (m *UserMutation) ClearAccessTokens() {
	m.clearedaccess_tokens = true
}

// AccessTokensCleared reports if the "access_tokens" edge to the RefreshToken entity was cleared.
func (m *UserMutation) AccessTokensCleared() bool {
	return m.clearedaccess_tokens
}

// RemoveAccessTokenIDs removes the "access_tokens" edge to the RefreshToken entity by IDs.
...
// RemovedAccessTokens returns the removed IDs of the "access_tokens" edge to the RefreshToken entity.
...
func (m *UserMutation) AddRestaurantIDs(ids ...int) {
	if m.restaurants == nil {
		m.restaurants = make(map[int]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemoveRestaurantIDs(ids ...int) {
	if m.removedrestaurants == nil {
		m.removedrestaurants = make(map[int]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemovedRestaurantsIDs() (ids []int) {
...
func (m *UserMutation) RestaurantsIDs() (ids []int) {
